                    ...
                    <React.Fragment key={step.id}>
                        ...
                        >
                            ...
                            <div className="text-left hidden md:block">
                                <p className={`text-[9px] font-bold uppercase tracking-wider ${openStep === step.id ? 'text-primary/70' : 'text-slate-400'}`}>Step {step.id}</p>
                    ...
                    <div className="p-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200/60 mb-6 transition-all hover:bg-white hover:shadow-sm">
                                ...
                                <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-700">Property Information</h4>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Listed By</p>
                                    <p className="text-sm font-bold text-slate-800 capitalize">{formData.uploadertype || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Property Type</p>
                                    <p className="text-sm font-bold text-slate-800 capitalize">{formData.propertyType || 'Not Provided'}</p>
                                </div>
                                <div className="md:col-span-2">
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Property Title</p>
                                    <p className="text-sm font-bold text-slate-800">{formData.title || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Area / Length</p>
                        ...
                        <div className="pt-8 border-t border-slate-100">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200/60 mb-6 transition-all hover:bg-white hover:shadow-sm">
                                ...
                                <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-700">Location Highlights</h4>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">City</p>
                                    <p className="text-sm font-bold text-slate-800">{formData.location?.city || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Locality</p>
                                    <p className="text-sm font-bold text-slate-800">{formData.location?.locality || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Project Name</p>
                                    <p className="text-sm font-bold text-slate-800">{formData.location?.projectName || 'Not Provided'}</p>
                                </div>
                                <div className="md:col-span-3">
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Full Address</p>
                    ...
                    <div className="p-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200/60 mb-6 transition-all hover:bg-white hover:shadow-sm">
                                ...
                                <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-700">Financial Structure</h4>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Expected Price</p>
                                    <p className="text-2xl font-black text-slate-800 tracking-tight">{formData.pricing?.expectedPrice || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Price per SqFt</p>
                                    <p className="text-lg font-black text-emerald-600">{formData.pricing?.pricePerSqft || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Maintenance</p>
                        ...
                        <div className="pt-1 ">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200/60 mb-6 transition-all hover:bg-white hover:shadow-sm">
                                ...
                                <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-700">Property Specifications</h4>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Furnishing Status</p>
                                    <p className="text-sm font-bold text-slate-800 capitalize">{formData.furnishingStatus || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Direction Faced</p>
                                    <p className="text-sm font-bold text-slate-800 capitalize">{formData.direction || 'Not Provided'}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-2">Availability Status</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-8 border-t border-slate-100">
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-4">Amenities Provided</p>
                            ...
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-4">Location Advantages</p>
                                <div className="flex flex-wrap gap-2">
                ...
                {openStep === 3 && (
                    <div className="p-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-4">Cover Asset</p>
                                {formData.coverPhoto ? (
                                    <div
                                        className="w-full h-[220px] rounded-xl overflow-hidden border border-slate-200 cursor-pointer shadow-lg transition-transform hover:scale-[1.02]"
                                    ...
                                    <div className="w-full h-[220px] rounded-xl bg-slate-50 border border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400">
                                        <ImageIcon size={40} className="mb-4 opacity-20" />
                                        <p className="text-[10px] font-bold uppercase tracking-wider">No Cover Photo</p>
                                    </div>
                                )}
                            </div>
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-4">Virtual Tour Video</p>
                                {formData.video ? (
                                    <div
                                        className="w-full h-[220px] rounded-xl overflow-hidden bg-slate-900 border border-slate-800 shadow-lg cursor-pointer relative group"
                                    ...
                                    <div className="w-full h-[220px] rounded-xl bg-slate-50 border border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400">
                                        ...
                                        <p className="text-[10px] font-bold uppercase tracking-wider">No Video Tour Provided</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="pt-10 border-t border-slate-100">
                            <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-6">Gallery Inspection</p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                {openStep === 4 && (
                    <div className="p-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-4">Ownership Proof</p>
                            ...
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-4">Lister Appearance</p>
                                {formData.uploader?.photo ? (
                                    <div
                                        className="w-24 h-24 rounded-full overflow-hidden border-2 border-slate-200 cursor-pointer shadow-md hover:border-primary transition-all"
                                    ...
                                    <div className="w-24 h-24 rounded-full bg-slate-50 border border-2 border-slate-200 flex items-center justify-center text-slate-300">
                                        <User size={32} />
                                    </div>
                                )}
                            </div>
                            <div className="md:pt-0 pt-4">
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200/60 mb-6 w-full">
                                    ...
                                    <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-700">Legal Reference</h4>
                                </div>
                                <div className="space-y-4">
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Attorney Name</p>
                                        <p className="text-sm font-bold text-slate-800 px-1">{formData.lawyerDetails?.name || 'Not Provided'}</p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Contact Reference</p>
                        ...
                        <div className="pt-10 border-t border-slate-100">
                            <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-6">Verified Certificates & Deeds</p>
                                ...
                                {[
                                    ...
                                    return (
                                        <div key={doc.id}>
                                            ...
                                            <p className="text-[10px] font-bold uppercase tracking-wider mt-3 text-center text-slate-600">{doc.label}</p>
                                        </div>
                                    );
                                })}
                            </div>
