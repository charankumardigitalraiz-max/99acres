            ...
            <div className="bg-white rounded-[2rem] border border-slate-200 shadow-xl shadow-slate-200/40 overflow-hidden">
                <div className="flex flex-col md:flex-row items-start gap-8 p-8">
                    <div className="relative shrink-0">
                        <Avatar initials={user.avatar} size="2xl" className="w-24 h-24 text-2xl" />
                        <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full flex items-center justify-center border-2 border-white text-white text-[10px] font-bold shadow ${user.status === 'Active' ? 'bg-emerald-500' : 'bg-rose-400'}`}>
